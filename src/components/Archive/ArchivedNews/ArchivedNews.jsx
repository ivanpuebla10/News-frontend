      ...
      <Card className="archive-card" key={news._id}>
        {fetched ? (
          ...
          <Link to={"/details/" + news._id} className="link-class">
            <Card.Img
              variant="top"
              src={"http://localhost:5000/images/" + news?.images[0]}
              className="archive-image"
            />
          </Link>
        )}
        <Card.Body>
          ...
          <Card.Text className="mb-2 text-muted">
            {news.description}
            <Link to={"/details/" + news._id} className="link-class">
              <Card.Subtitle className="read-more" style={{ margin: "1rem" }}>
                Read More{">>"}
              </Card.Subtitle>
            </Link>
          </Card.Text>
          ...
          <Button
            variant="primary"
            onClick={() => dispatch(removeNews(news._id))}
          >
            Remove
          </Button>
        </Card.Body>
      ...
      {listNews.length !== 0 ? (
        ...
        <Card style={{ height: "100vh" }}>
          ...
          <Card.Body>
            ...
            <Card.Text>Go to news page and click on "archive".</Card.Text>
